...
route.patch("/updatepassword/:id", verifyToken.verifyTokenAndAh,  AppChcontrollers.updatepassword)
route.patch("/biographie/:id", verifyToken.verifyTokenAndAh,  AppChcontrollers.biographie)
route.patch("/uploidprofile/:id", verifyToken.verifyTokenAndisAdmin, upload, AppChcontrollers.uploadeProfile)
